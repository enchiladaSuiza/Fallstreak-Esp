...
define config.name = _("Fallstreak")
...
define config.main_menu_music = "ost/2 Golden Lullaby.ogg"
...
define config.enter_sound = "se/StartSelect,UI,set3,pure,warm,simple,quick,tonal,deaction.ogg"
define config.exit_sound = "se/TheLibrarybyMTC_UI_Droplet_06.ogg"
...
define config.save_directory = "Fallstreak-1526157331"
